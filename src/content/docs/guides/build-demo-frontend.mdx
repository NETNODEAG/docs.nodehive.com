---
title: Demo Frontend
description: Use this demo frontend to see a NodeHive frontend in action
---

## Next.js Starter Template

:::note
This is a demo/starter template for Next.js. The frontend is pre-configured to work with the NodeHive demo backend (https://demo.nodehive.app).
You could use this template to start your own project but we recommend to build a fresh project with https://github.com/NETNODEAG/nodehive-nextjs-minimal-starter
